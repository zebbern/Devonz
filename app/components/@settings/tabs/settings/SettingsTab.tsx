...
export default function SettingsTab() {
  ...
  return (
    <div className="space-y-4">
      ...
      <motion.div
        className="bg-white dark:bg-[#0b0d13] rounded-lg shadow-sm dark:shadow-none p-4 space-y-4"
      ...
      {/* Timezone */}
      <motion.div
        className="bg-white dark:bg-[#0b0d13] rounded-lg shadow-sm dark:shadow-none p-4"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between p-2 rounded-lg bg-[#FAFAFA] dark:bg-[#1a2332]">
            ...
            <div className="flex items-center gap-1">
              <kbd className="px-2 py-1 text-xs font-semibold text-bolt-elements-textSecondary bg-white dark:bg-[#0b0d13] border border-[#E5E5E5] dark:border-[#1a2332] rounded shadow-sm">
