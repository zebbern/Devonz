                ...
                <RadixDialog.Root open={isOpen} onOpenChange={(open) => !open && handleClose()}>
                    <RadixDialog.Portal>
                        ...
                        <RadixDialog.Content asChild>
                            <motion.div
                                className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[9999] w-[90vw] max-w-5xl h-[85vh] bg-bolt-elements-background-depth-1 rounded-lg shadow-xl border border-bolt-elements-borderColor flex flex-col focus:outline-none"
                                initial="closed"
                                animate="open"
                                exit="closed"
